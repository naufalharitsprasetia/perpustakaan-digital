    ...
    <form action="/edit-buku/{{ $book->id_buku }}" method="post" class="mt-4" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('nomer_rak_buku') is-invalid @enderror" id="nomer_rak_buku"
                name="nomer_rak_buku" value="{{ old('nomer_rak_buku', $book->nomer_rak_buku) }}"
                placeholder="Nomer Rak Buku">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('kelas_buku') is-invalid @enderror" id="kelas_buku"
                name="kelas_buku" value="{{ old('kelas_buku', $book->kelas_buku) }}" placeholder="Kelas Buku">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('isbn_buku') is-invalid @enderror" id="isbn_buku"
                name="isbn_buku" value="{{ old('isbn_buku', $book->isbn_buku) }}" placeholder="ISBN Buku">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('penulis_buku') is-invalid @enderror" id="penulis_buku"
                name="penulis_buku" value="{{ old('penulis_buku', $book->penulis_buku) }}" placeholder="Penulis Buku">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('penerbit_buku') is-invalid @enderror" id="penerbit_buku"
                name="penerbit_buku" value="{{ old('penerbit_buku', $book->penerbit_buku) }}" placeholder="Penerbit Buku">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('kode_buku') is-invalid @enderror" id="kode_buku"
                name="kode_buku" value="{{ old('kode_buku', $book->kode_buku) }}" placeholder="Kode Buku">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('urutan_buku') is-invalid @enderror" id="urutan_buku"
                name="urutan_buku" value="{{ old('urutan_buku', $book->urutan_buku) }}" placeholder="Urutan Buku">
